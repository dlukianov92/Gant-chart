...
## 17. Hotfix v25
- Убрана сломанная виртуализация Gantt (`getVisibleDayRange` не был определён → падал `render()`).
- Укреплено создание/открытие проектов.
- Улучшен drag пакетов на touch.
